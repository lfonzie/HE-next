...
async function testTiSupportModule() {
  ...
  try {
    ...
    const playbookFiles = ['printer.yaml', 'wifi.yaml', 'software.yaml', 'general.yaml']
    ...
    console.log('\n🎉 All basic tests passed! TI Support Module with AI Playbook Generation is ready!')
    console.log('\n📋 Next steps:')
    console.log('   • Run "npm run dev" to start the development server')
    console.log('   • Visit http://localhost:3000/ti to test the universal UI')
    console.log('   • Visit http://localhost:3000/ti/ai-demo to test AI playbook generation')
    console.log('   • Try any TI problem - system will generate playbook automatically')
    console.log('   • Test the guided chat flow with AI-generated playbooks')
