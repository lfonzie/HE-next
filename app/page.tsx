...
const planos = {
  title: "Preços",
  subtitle: "Preço fixo, sem surpresas. Todos os recursos inclusos.",
  plans: [
    {
    ...
    <section className="py-20 bg-white" aria-labelledby="faq-title">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          ...
          <button 
            className="px-8 py-3 bg-yellow-400 hover:bg-yellow-500 text-black font-bold transform hover:scale-105 transition-all duration-300 shadow-lg rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-400"
      ...
      <section className="bg-gradient-to-r from-yellow-50 to-white text-black pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <a 
              href="/demo-register" 
                  className="group px-8 py-4 bg-yellow-400 hover:bg-yellow-500 text-black font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg flex items-center justify-center gap-2"
            >
      ...
      <section className="py-20 bg-gradient-to-b from-gray-900 to-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            ...
            <button className="px-8 py-3 bg-yellow-400 hover:bg-yellow-500 text-black font-bold rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {planos.plans.map((plan, index) => (
              <div key={index} className={`p-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-transform ${
                ...
                <button className={`w-full font-bold py-4 rounded-xl transition-colors text-lg border-2 ${
                  plan.highlight
      ...
      <section className="bg-gradient-to-b from-neutral-950 to-neutral-900 text-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a 
              href="/demo-register" 
              className="group px-8 py-4 bg-yellow-400 hover:bg-yellow-500 text-black font-bold text-lg rounded-xl transform hover:scale-105 transition-all duration-300 shadow-lg flex items-center justify-center gap-2"
            >
              <Play className="w-5 h-5 group-hover:scale-110 transition-transform" />
              Teste Grátis - Demo IA
            </a>
          ...
          <div className="grid lg:grid-cols-4 gap-12 mb-12">
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-4">
                <a 
                  href="/demo-register" 
                  className="px-6 py-3 bg-yellow-400 hover:bg-yellow-500 text-black font-bold rounded-xl transform hover:scale-105 transition-all duration-300"
                >
                  Solicitar Demo
                </a>
                <a 
                  href="/login" 
                  className="px-6 py-3 rounded-xl bg-neutral-900 text-white hover:bg-neutral-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 font-semibold transition-colors"
                >
                  Entrar
                </a>
              </div>
