...
import { SimulatorErrorBoundary } from '@/components/enem/SimulatorErrorBoundary'
import { sanitizeQuestion } from '@/lib/enem-data-sanitizer'
                ...
                <div className="space-y-3">
                  {question.options.map((option: string, index: number) => (
                    <AlternativeButton
                      ...
                      text={option}
                      index={index}
                      isSelected={state.answers[state.currentQuestion] === index.toString()}
          ...
          {state.isFinished && (
            <div className="text-center py-8">
              ...
              <div className="flex gap-3 justify-center">
                ...
                <Button onClick={() => router.push('/enem')}>
                  <ArrowLeft className="h-4 w-4 mr-2" />
                  Novo Simulado
                </Button>
              </div>
