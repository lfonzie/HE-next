...
export function generateImageQuery(topic, slideNumber, slideType) {
  const queries = {
    1: `${topic} introduction education classroom`, // Abertura
    2: `${topic} concept overview education`, // Conceito principal
    3: `${topic} process mechanism education`, // Desenvolvimento
    4: `${topic} quiz test education classroom`, // Quiz 1
    5: `${topic} application practice education`, // Aplicação
    6: `${topic} advanced concepts education`, // Aprofundamento
    7: `${topic} connections real world education`, // Conexões
    8: `${topic} analysis quiz education`, // Quiz 2
    9: `${topic} summary conclusion education` // Encerramento
  };
