  ...
  const playNextAudio = async () => {
    ...
    try {
      ...
      audio.onended = () => {
        ...
        playNextAudio() // Reproduzir próximo
      }
      ...
      await audio.play()
      console.log('🔊 Reproduzindo áudio via HTML5 Audio')
          ...
          if (line.startsWith('data: ')) {
            ...
            switch (data.type) {
              ...
              case 'turn_complete':
                ...
                setStatusText(hasAudio ? '🔊 Reproduzindo resposta...' : '✅ Pronto para próxima pergunta')
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-indigo-900/20 dark:to-purple-900/20 p-4">
      <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center space-y-3">
              <div className="flex items-center justify-center gap-3">
                ...
                <CardTitle className="text-3xl font-bold">
                  Conversa Automática ao Vivo
                </CardTitle>
                <Zap className="w-8 h-8" />
              </div>
              <p className="text-indigo-100 text-lg">
                Fale naturalmente e a IA responde em áudio automaticamente
              </p>
            </div>
          </CardHeader>
          ...
          <CardContent className="p-8 space-y-6">
            ...
            {messages.length === 0 && (
              <Alert className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-indigo-200 dark:border-indigo-700">
                ...
                <AlertDescription>
                  <p className="font-semibold mb-3 text-lg">🎯 Como funciona:</p>
                  <ol className="space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>Fale por até 5 segundos (ou clique para parar antes)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="font-bold text-indigo-600 dark:text-indigo-400">3.</span>
                      <span>A IA processa e responde automaticamente em áudio!</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="font-bold text-indigo-600 dark:text-indigo-400">4.</span>
                      <span>Continue a conversa naturalmente ✨</span>
                    </li>
                  </ol>
                </AlertDescription>
              </Alert>
        ...
        <div className="mt-4 text-center text-sm text-muted-foreground space-y-1">
          ...
          <p>Conversação em tempo real com streaming de áudio bidirecional</p>
        </div>
      </div>
    </div>
  )
